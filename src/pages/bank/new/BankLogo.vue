...
const fileData = ref<FileData[]>(props.file)
const file = ref(props.file)
const { open, onChange } = useFileDialog({ multiple: false, accept: 'image/*' })
...
watch(() => props.file, newValue => emit('update:file', newValue))
