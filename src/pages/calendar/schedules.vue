...
import { ref } from 'vue'
import CalendarEventHandler from '@/views/calendar/schedules/CalendarEventHandler.vue'
import { blankEvent, useCalendar } from '@/views/calendar/schedules/useCalendar'
import { useCalendarStore } from '@/views/calendar/schedules/useCalendarStore'
...
onUnmounted(() => {
  useCookie('scheduleIDCookie').value = null
})
