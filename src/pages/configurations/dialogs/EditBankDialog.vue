...
const bankdata = ref(structuredClone(toRaw(props.bank)))

// Form fields
const bankName = ref(bankdata.value.name)
const status = ref(bankdata.value.status)
