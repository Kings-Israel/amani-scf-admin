...
interface Emit {
  (e: 'update:bankManual', value: File): void
}
...
const fileData = ref<FileData[]>(props.bankManual)
const bankManual = ref(props.bankManual)
...
watch(() => props.bankManual, newValue => emit('update:bankManual', newValue))
