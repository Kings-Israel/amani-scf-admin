...
interface Emit {
  (e: 'update:dealerManual', value: File): void
}
...
const fileData = ref<FileData[]>(props.dealerManual)
const dealerManual = ref(props.dealerManual)
...
watch(() => props.dealerManual, newValue => emit('update:dealerManual', newValue))
