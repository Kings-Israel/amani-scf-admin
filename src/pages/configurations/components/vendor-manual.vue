...
interface Emit {
  (e: 'update:vendorManual', value: File): void
}
...
const fileData = ref<FileData[]>(props.vendorManual)
const vendorManual = ref(props.vendorManual)
...
watch(() => props.vendorManual, newValue => emit('update:vendorManual', newValue))
