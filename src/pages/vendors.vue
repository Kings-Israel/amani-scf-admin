...
const { data: productsData, execute: fetchProducts } = await useApi<any>(createUrl('/programs/buyers-dealers/vendors',
  {
    query: {
      q: searchQuery,
...
const exportToExcel = () => {
  ...
  saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'Vendors.xlsx')
}
</script>
