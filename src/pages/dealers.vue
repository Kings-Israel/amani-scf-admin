...
const { data: productsData, execute: fetchProducts } = await useApi<any>(createUrl('/programs/buyers-dealers/dealers',
  {
    query: {
      q: searchQuery,
...
const exportToExcel = () => {
  ...
  saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'Dealers.xlsx')
}
</script>
