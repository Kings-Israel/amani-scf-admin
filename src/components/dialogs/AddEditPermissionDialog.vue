...
const currentPermissionName = ref(props.permissionName)
...
const onSubmit = async () => {
  console.log(props.permissionID)
  await $api(`/UI/roles/${props.permissionID}/rolename/update`, {
    method: 'POST',
    body: {
      rolename: currentPermissionName.value,
    },
