...
const { data: programData, execute: fetchPrograms } = await useApi<any>(createUrl('/get/UI/all/programs/pending', {
  query: queryParams,
}))
...
const exportToExcel = () => {
  ...
  saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'Pending_Approval_Programs.xlsx')
}
