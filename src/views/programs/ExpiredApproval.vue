...
const { data: programData, execute: fetchPrograms } = await useApi<any>(createUrl('/get/UI/all/programs/expired', {
  query: queryParams,
}))
...
const exportToExcel = () => {
  ...
  saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'Expired_Programs.xlsx')
}
