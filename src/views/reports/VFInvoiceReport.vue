...
const { data: invoiceData, execute: fetchInvoiceData } = await useApi<any>(createUrl('/admin/vfrequests/invoices', {
  query: queryParams,
}))
...
<template>
  <VCol>
    <h2 class="my-4 mx-5">
      <b> VF - Potential Financing Report  </b>
    </h2>
        ...
        <div class="d-flex flex-wrap gap-4 mx-5 my-5">
          <div class="d-flex align-center flex-wrap gap-4">
            ...
            <AppTextField
              ...
              style=" flex: 1 auto;min-inline-size: 250px;"
              type="text"
            />
            <AppTextField
              ...
              color="primary"
              placeholder="Dealer"
              style=" flex: 1 1 auto;min-inline-size: 250px;"
              type="text"
            />
            <AppTextField
