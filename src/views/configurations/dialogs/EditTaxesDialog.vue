...
// Form fields
const taxname = ref(taxdata.value.name)
const percentage = ref(taxdata.value.percentage)
const accountno = ref(taxdata.value.account_no)
const status = ref(taxdata.value.status)

const submitRate = async () => {
  try {
    const res = await $api('UI/configurations/edit/tax-rates-configurations', {
      method: 'POST',
      body: {
